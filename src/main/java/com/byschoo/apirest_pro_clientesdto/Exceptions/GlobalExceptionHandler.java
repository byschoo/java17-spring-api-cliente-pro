...
import com.byschoo.apirest_pro_clientesdto.Payload.MessageResponseError;
import com.byschoo.apirest_pro_clientesdto.Payload.ValidationResponseError;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleMethodArgumentNotValidException(MethodArgumentNotValidException ex, WebRequest webRequest) {
        ...
        ValidationResponseError errorResponse =             
            ValidationResponseError.builder()
    ...
    public ResponseEntity<MessageResponseError> handleResourceNotFoundException(ResourceNotFoundException ex, WebRequest webRequest) {
    ...
    public ResponseEntity<MessageResponseError> handleBusinessException(BusinessException ex, WebRequest webRequest) {
        log.error("Exception Occured: " + ex.getClass().getSimpleName() + " - " + ex.getLocalizedMessage(), ex);
    ...
    public ResponseEntity<MessageResponseError> handleNoHandlerFoundException(NoHandlerFoundException ex, WebRequest webRequest) {
    ...
    public ResponseEntity<MessageResponseError> handleBadRequestException(BadRequestException ex, WebRequest webRequest) {
        log.error("Exception Occured: " + ex.getClass().getSimpleName() + " - " + ex.getMessage(), ex);
    ...
    public ResponseEntity<MessageResponseError> handleDataIntegrityViolationException(DataIntegrityViolationException ex, WebRequest webRequest) {
        log.error("Exception Occured: " + ex.getClass().getSimpleName() + " - " + ex.getMessage(), ex);
    ...
    public ResponseEntity<MessageResponseError> handleEmptyResultDataAccessException(EmptyResultDataAccessException ex, WebRequest webRequest) {
        log.error("Exception Occured: " + ex.getClass().getSimpleName() + " - " + ex.getMessage(), ex);
    ...
    public ResponseEntity<MessageResponseError> handleDataAccessResourceFailureException(DataAccessResourceFailureException ex, WebRequest webRequest) {
        log.error("Exception Occured: " + ex.getClass().getSimpleName() + " - " + ex.getMessage(), ex);
    ...
    public ResponseEntity<MessageResponseError> handleHttpMessageNotReadableException(HttpMessageNotReadableException ex, WebRequest webRequest) {
        log.error("Exception Occured: " + ex.getClass().getSimpleName() + " - " + ex.getMessage(), ex);
    ...
    public ResponseEntity<MessageResponseError> handleCannotCreateTransactionException(CannotCreateTransactionException ex, WebRequest webRequest) {
        log.error("Exception Occured: " + ex.getClass().getSimpleName() + " - " + ex.getMessage(), ex);
    ...
    public ResponseEntity<MessageResponseError> handleException(Exception ex, WebRequest webRequest) {
        log.error("Exception Occured: " + ex.getClass().getSimpleName() + " - " + ex.getMessage(), ex);
